...
alias normal-brightness='sudo tee /sys/class/backlight/intel_backlight/brightness <<< 500'
alias cat='bat'
alias reset-trackpad='sudo modprobe -r psmouse; sudo modprobe psmouse'
alias undocked='xrandr --output eDP-1 --auto; xrandr --output DP-2-1 --off'
alias games='xrandr --output DP-2-1 --auto; xrandr --output eDP-1 --off'
alias docked='xrandr --output DP-2-1 --auto; xrandr --output eDP-1 --auto --right-of DP-2-1'
...
alias update-mirrors='sudo reflector --latest 5 --sort rate --save /etc/pacman.d/mirrorlist'
